...
$ConfigData = @{
    AllNodes = @(
        ...
        @{
            ...
            AutomationEndpoint = 'https://we-agentservice-prod-1.azure-automation.net/accounts/<ID>'
            Token = Get-Credential -Message AutomationKey -UserName AutomationAccount
            GroupName = 'MyHybridGroup'
        }
    )
}
